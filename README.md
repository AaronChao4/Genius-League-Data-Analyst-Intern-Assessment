...
To complete this task, we first clean up the data and create charts to analyze our data using Excel. The Excel file that includes the original data, the cleaned data, and the graphs/charts can be found [https://github.com/AaronChao4/DA-Intern-Assessment/blob/main/social_data_edited_05_26_23.xlsx](here). Finally, we present our findings in this [https://github.com/AaronChao4/DA-Intern-Assessment/blob/main/DA%20Intern%20Assessment%20Powerpoint%20(PPT%20File.pptx](powerpoint), or if a PDF file is preferred for readability, it can be found [https://github.com/AaronChao4/DA-Intern-Assessment/blob/main/DA%20Intern%20Assessment%20Powerpoint%20(PDF%20File).pdf](here).
